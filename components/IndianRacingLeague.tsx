  ...
  return (
    <div className="flex flex-col items-center px-10 py-10 bg-black">
      <div className="flex gap-10">
        <img src="https://cdn.siasat.com/wp-content/uploads/2022/11/shvbsvs.jpg" alt="" className="h-[500px] object-contain rounded-2xl"/>
        <div className="flex flex-col justify-between">
          ...
          <h1 className={`${orbitron.className} text-4xl font-bold text-center`}>SCOUTING FOR THE <br/> <span className="text-orange-500">INDIAN</span> RACING <span className="text-green-500">LEAGUE</span></h1>
          <img src="https://cdn.siasat.com/wp-content/uploads/2022/11/shvbsvs.jpg" alt="" className="h-32 object-cover object-top rounded-2xl"/>
        </div>
        <img src="https://cdn.siasat.com/wp-content/uploads/2022/11/shvbsvs.jpg" alt="" className="h-[500px] object-contain rounded-2xl"/>
      </div>
